 ...
 * @param {String} vendorType - 'Lab' | 'Pharmacy' | 'Food' | 'Hospital' | 'Doctor' | 'Ambulance'
 ...
 * @param {String} vendorId - Doctor, Lab, Pharmacy, Food, Hospital, or Ambulance _id
 * @param {String} vendorModel - 'Doctor' | 'Lab' | 'Pharmacy' | 'Food' | 'Hospital' | 'Ambulance'
