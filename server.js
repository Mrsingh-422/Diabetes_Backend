...
app.use('/api/homepage/blogs', require('./routes/admin/user/home/blog'));
app.use('/api/homepage/science', require('./routes/admin/user/home/SciencePage'));
app.use("/upload-videos", require("./routes/admin/user/home/video"));
app.use("/api/contactus", require("./routes/admin/user/home/ContactUsRoute")); // Contact Us Management Route
app.use("/api/aboutus", require("./routes/admin/user/home/AboutUsPageRoute")); // About Us Management Route
